...
namespace Stariluz
{
    public class NewPlayerBehavior : MonoBehaviour
    {
        ...
        {
            Vector2 raycastOrigin = transform.position;
            raycastOrigin.y += (isDown ? 1 : -1) * ((playerHeight / 2) + (playerHeight / 1000));
            Vector2 upDirection = transform.TransformDirection((isDown ? 1 : -1) * Vector2.up);
        ...
        protected void Teleport(RaycastHit2D hit)
        {
            ...
            Vector2 newPosition = new Vector2(impactPoint.x, impactPoint.y + (isDown ? -1 : 1) * playerHeight / 2);
        ...
        protected void OnDrawGizmos()
        {
            ...
            Vector2 downDirection = transform.TransformDirection((isDown ? 1 : -1) * Vector2.down);
